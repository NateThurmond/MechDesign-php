...
/*
    ...
    Notes: There's still security concerns here but seeing as registration doesn't actually
        do anything, I'll leave this for historic purposes.
*/

require_once("../config/config.php");
require_once("../php/sqlPrepare.php");

$conn = mysqli_connect(DBHOST, DBUSER, DBPASS, DBNAME) or die("Error: Conn Error");
